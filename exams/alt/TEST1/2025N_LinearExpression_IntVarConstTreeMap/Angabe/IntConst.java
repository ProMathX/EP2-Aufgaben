...
public class IntConst {
    ...
    // IntConst object representing values used often:
    public static final IntConst ZERO = new IntConst(0);
    public static final IntConst ONE = new IntConst(1);
    ...
    /**
     * Returns 'true' only if 'this' represents the value 1.
     * @return 'true' if 'this' represents the value 1, otherwise 'false'.
     */
