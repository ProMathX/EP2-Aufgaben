    ...
    public static void main(String[] args) {
        checkAndPrint(
                ...
                new Question(
                        ...
                        new Choice(true, "Vorbedingung: z >= 1.                                                              (1A)"),
                ...
                new Question(
                        ...
                        new Choice(true, "Kommentare sollen aus Sicht der Anwendung geschrieben sein.                        (2B)"),
                        ...
                        new Choice(true, "Die meisten Kommentare stehen im Rumpf von Methoden und Konstruktoren.             (2E)")
                ),
                ...
                new Question(
                        ...
                        new Choice(true, "Ausgaben über gepufferte Streams gehen direkt an das Betriebssystem.               (3D)"),
                ...
                new Question(
                        ...
                        new Choice(true, "Aus  v.equals(w)  und  w.equals(x)  folgt  v.equals(x).                            (4A)"),
                        new Choice(false, "null.equals(null)  gibt  true  zurück.                                             (4B)"),
                        new Choice(true, "Aus  w.hashCode() != x.hashCode()  folgt  !w.equals(x).                            (4C)"),
                ...
                new Question(
                        ...
                        new Choice(true, "i > 0 && i < p                                                                     (5B)"),
                        new Choice(true, "i > 1                                                                              (5C)"),
                        new Choice(false, "i >= 1 && i <= p                                                                   (5D)"),
                        new Choice(true, "w ist das Produkt aller Zahlen von 1 bis i, also 1*...*i                           (5E)")
                )
        );
    }
