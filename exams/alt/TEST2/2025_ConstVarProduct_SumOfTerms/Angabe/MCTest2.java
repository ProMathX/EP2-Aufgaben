    ...
    public static void main(String[] args) {
        checkAndPrint(
                ...
                new Question(
                        ...
                        new Choice(false, "s ist das Produkt aller Zahlen von 1 bis j, also 1*...*j                           (1A)"),
                        new Choice(false, "j > 0 && j < q                                                                     (1B)"),
                        new Choice(false, "s >= q                                                                             (1C)"),
                        new Choice(false, "j >= 1 && j <= 60                                                                  (1D)"),
                ...
                new Question(
                        ...
                        new Choice(false, "Vorbedingung: Lässt h unverändert.                                                 (2A)"),
                        ...
                        new Choice(false, "Nachbedingung: Ergebnis hängt von einem Eintrag von h ab.                          (2E)")
                ),
                ...
                new Question(
                        ...
                        new Choice(false, "Vorbedingungen beschreiben häufig Eigenschaften von Parametern.                    (3C)"),
                        new Choice(false, "Invarianten beziehen sich auf Objektzustände.                                      (3D)"),
                ...
                new Question(
                        ...
                        new Choice(false, "Das Java-Laufzeitsystem wirft nur unüberprüfte (unchecked) Ausnahmen.              (4B)"),
                ...
                new Question(
                        ...
                        new Choice(false, "Eine Code-Review hilft beim Auffinden von Fehlerursachen.                          (5A)"),
                        ...
                        new Choice(false, "Black-Box-Testen legt Testfälle vor der Implementierung fest.                      (5D)"),
