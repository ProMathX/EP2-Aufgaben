...
public class Ant {
    ...
    private final Vector2DStack path;
    ...
    public void step() {
        ...
        if (!carryingFood) { // make a step searching for food
            ...
            // TODO: store current position in your path here
            ...
            state = world.enforceBoundary(new State(path.pop(), state.getVelocity()));
